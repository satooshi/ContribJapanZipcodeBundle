...
use Contrib\Bundle\JapanZipcodeBundle\Adapter\OfficeZipcode\FindByZipcode;
...
class OfficeZipcodeRepository extends EntityRepository
{
    ...
    public function findByZipcode($zipcode, $limit = 100, $offset = 0)
    {
        ...
        return $adapter
            ...
            ->fetchAll(\PDO::FETCH_CLASS, 'Contrib\Bundle\JapanZipcodeBundle\Entity\OfficeZipcode');
    }
}
